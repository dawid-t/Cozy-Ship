...
- The water shader was created based on this [ShaderGraph tutorial](https://youtu.be/78WCzTVmc28).  
  To simulate the ship's swaying on the water, I used DOTween to create procedural animations.

  If you want to create physics for ships and other objects that react to waves, I recommend this tutorial: https://youtu.be/eL_zHQEju8s + a tutorial on how to create realistic waves using a shader, which can be combined with that physics: https://catlikecoding.com/unity/tutorials/flow/waves
...
- The project was developed in **Unity 6 (6000.0.38f1)** and **Universal Render Pipeline (URP)**.
...
**Click to play a short showcase video:**
[![Click to play a short showcase video](https://img.youtube.com/vi/pvi72kkWM94/maxresdefault.jpg)](https://www.youtube.com/shorts/pvi72kkWM94)
